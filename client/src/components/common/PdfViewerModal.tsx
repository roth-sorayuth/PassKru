      ...
      <div className="relative w-full max-w-5xl h-[88vh] bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden flex flex-col z-10">
        ...
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-slate-200 bg-slate-50">
          <h3 className="text-sm font-normal text-black flex items-center gap-2 truncate">
            ...
            <span className="truncate">{title || 'មើលឯកសារវិញ្ញាសា'}</span>
          </h3>
          <div className="flex items-center gap-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-1.5 text-slate-500 hover:text-black bg-white hover:bg-slate-100 border border-slate-200 rounded-lg transition flex items-center gap-1 text-xs"
