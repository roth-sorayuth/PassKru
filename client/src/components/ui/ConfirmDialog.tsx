      ...
      >
        ...
        <div className="flex items-center justify-end gap-3 pt-2 border-t border-slate-100">
          <button
            ...
            onClick={onCancel}
            disabled={busy}
            className="px-4 py-2 rounded-xl text-sm font-semibold text-slate-600 hover:bg-slate-100 transition cursor-pointer disabled:opacity-50"
          >
            {cancelLabel}
          </button>
          <button
            ...
            onClick={onConfirm}
            disabled={busy}
            className={`px-5 py-2 rounded-xl text-white font-bold text-sm shadow-xs transition cursor-pointer flex items-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed ${
              destructive
