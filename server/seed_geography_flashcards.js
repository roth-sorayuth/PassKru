...
const DECKS_CONFIG = [
  { deckId: 701, title: "ឈុតទី ១: ភូមិវិទ្យាកម្ពុជា & ពិភពលោក - មូលដ្ឋាន", description: "ព្រំប្រទល់កម្ពុជា បឹងទន្លេសាប ទ្វីប និងមហាសមុទ្រ" },
  { deckId: 702, title: "ឈុតទី ២: ភូមិសាស្ត្រ & អាកាសធាតុ", description: "រដូវកាល ដីស្រែបាត់ដំបង និងលក្ខណៈអាកាសធាតុ" },
  { deckId: 703, title: "ឈុតទី ៣: ធនធានធម្មជាតិ & កោះកម្ពុជា", description: "កោះទ្រង់ ភ្នំគូលែន ស្ពានគីហ្សូណា និងបឹងយក្សឡោម" },
  { deckId: 704, title: "ឈុតទី ៤: ភូមិវិទ្យាអន្តរជាតិ & ឧទ្យានជាតិ", description: "ចតុមុខ ឧទ្យានជាតិបូកគោ ព្រែកជីកប៉ាណាម៉ា និងជួរភ្នំអ៊ូរ៉ាល់" },
  { deckId: 705, title: "ឈុតទី ៥: កសិកម្ម & ភូមិសាស្ត្រតំបន់", description: "ច្រកប៉ោយប៉ែត ទន្លេអាម៉ាហ្សូន ខេត្តមណ្ឌលគីរី និងខ្សែរយៈទទឹង-បណ្តោយ" },
];
