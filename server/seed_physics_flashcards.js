...
const DECKS_CONFIG = [
  { deckId: 201, title: "វិញ្ញាសារទី ១: មេកានិច & ថាមពល", description: "ល្បឿន សំទុះ ច្បាប់ញូតុន និងថាមពលមេកានិច" },
  { deckId: 202, title: "វិញ្ញាសារទី ២: អគ្គិសនី & រលក", description: "ច្បាប់អូម រេស៊ីស្តង់ ខួប និងប្រេកង់រលក" },
  { deckId: 203, title: "វិញ្ញាសារទី ៣: អុបទិក & ទែម៉ូឌីណាមិក", description: "ច្បាប់ចាំងពន្លឺ លិបិក្រម និងសីតុណ្ហភាពដាច់ខាត" },
  { deckId: 204, title: "វិញ្ញាសារទី ៤: មេកានិចរាវ & ម៉ាញេទិច", description: "កម្លាំងអាក្យូម៉ែដ កម្លាំងឡូរ៉ង់្ស និងសមីការ E=mc²" },
  { deckId: 205, title: "វិញ្ញាសារទី ៥: រូបវិទ្យាទំនើប & មេកានិច", description: "ការងារកម្លាំង សន្ទុះ ច្បាប់និចលភាព និងអានុភាព" },
  { deckId: 206, title: "វិញ្ញាសារទី ៦: មេកានិចរាវ & ទែម៉ូឌីណាមិក", description: "សម្ពាធរាវ គោលការណ៍ប៉ាស្កាល់ និងច្បាប់ទែម៉ូឌីណាមិក" },
  { deckId: 207, title: "វិញ្ញាសារទី ៧: អគ្គិសនី & ម៉ាញេទិច", description: "ច្បាប់គូឡុំ ដែនម៉ាញេទិច និងលំហូរម៉ាញេទិច" },
  { deckId: 208, title: "វិញ្ញាសារទី ៨: រលក, អុបទិក & រូបវិទ្យាទំនើប", description: "កញ្ចក់ប៉ោង កញ្ចក់ផိန် ហ្វូតុង និងអ៊ីសូតូប" },
  { deckId: 209, title: "វិញ្ញាសារទី ៩: រូបវិទ្យាអាតូម & ណ្វៃយ៉ូ", description: "បដិកម្មបំបែកណ្វៃយ៉ូ ប៉ោលសាមញ្ញ និងដង់ស៊ីតេ" },
  { deckId: 210, title: "វិញ្ញាសារទី ១០: មេកានិច & ទែម៉ូឌីណាមិក", description: "សមីការស្ថានភាពឧស្ម័ន កុងដង់ស៊័រ និងចំណាំងផ្លាត" },
];
